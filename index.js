...
function get20s(array, years) {
  ...
  for (let i = 0; i < array.length; i++){
    if (artists[i].years.includes(years)){ 
...
function addArtist() {
  let person = {
    name: "Joe Panetta",
    years: "1981 - 08/14/2020",
    id: 20,
    genre: "Web design",
    nationality: "Italian",
    bio:"Whole lotta hooey about me and you never know what else. Thanks for reading"
  }
  //console.log(person,"person")
  //console.log(artists)
   artists.push(person)

//console.log(artists.unshift(person))
}
addArtist()
...
function lotsOfArt(artists) {
  for (let i = 0; i < array.length; i++) {
   ...
   return newArtistArray.push(artists[i]);
    }
